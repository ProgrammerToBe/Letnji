...
public interface KlijentRepository extends CrudRepository<Klijent, Long>{
	...
	public Set<Klijent> findByJmbgContainingIgnoreCaseOrImeContainingIgnoreCaseOrPrezimeContainingIgnoreCaseOrAdresaContainingIgnoreCaseOrTelefonContainingIgnoreCaseOrEmailContainingIgnoreCaseAndNaseljenoMesto(String jmbg,
